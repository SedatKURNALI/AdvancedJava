...
public class Kitapci_Main {
	...
	public static void main(String[] args) {
		...
		do {
			...
			switch (islem) {
			case 1:
				Kitapci_KitapEkle.kitapEkle();
				break;
			case 2:
				Kitapci_KitapEkle.kitapNoIleKitap();
				break;
			case 3:
				Kitapci_KitapEkle.bilgiIleKitap();
				break;
			case 4:
				Kitapci_KitapEkle.numaraIleKitapSil();
				break;
			case 5:
				Kitapci_KitapEkle.tumKitaplariListele();
				break;
			case 6:
