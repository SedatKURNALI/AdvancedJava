package _AdvancedJava.JavaProjects.P01_FilmTahmin;
...
public class FilmTahmin {
    ...
    private static void filmGetir(List<String> film, int index) {
        ...
        do {
            ...
            System.out.print("yanlıs tahmin sayisi: " + (tahminSayisi - dogruTahminSayisi) + "/" + 2 * film.get(index).length() + "\ntahmin ettiginiz harfi giriniz : ");//yanlıs girilen tahmin sayisini print edildi
        ...
        } while ((tahminSayisi - dogruTahminSayisi) != 2 * film.get(index).length());//yanlış sayısı verilen hakka ulaşana kadar do body calışır
