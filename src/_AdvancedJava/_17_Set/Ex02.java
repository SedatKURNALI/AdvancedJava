...
Colections.sort(arr1)
    ...
    private static ArrayList<Integer> arrListHazirla(int size, int min, int max) {//bu method create edilecek arrlist size kadar min ile max arsında int sayı cerate eder
