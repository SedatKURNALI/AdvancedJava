package _AdvancedJava._04_switchCase;
                ...
                switch (kisi) {
                    case 1:
                        System.out.println("1 kişilik bilet talep ettiniz " + "bilet tutarınız : "
                                + frUcret + " EURO" + " güncel bakıyeniz: " + (bakiye -= frUcret)+" EURO");


                        break;
                    case 2:
                        System.out.println("2 kişilik bilet talep ettiniz " +
                                "bilet tutarınız : " + (frUcret * 2) + " EURO" + " güncel bakıyeniz: " + (bakiye -= frUcret * 2)+" EURO");
