...
public class QMarket {
    ...
    public static void main(String[] args) {
        ...
        getOrtalamaKazanc();
        getOrtalamaninUstundeKazancGuleri();
        ...
        System.out.println("   ***   ");
        System.out.println("ortalamanın üstündeki gün : " + getOrtalamaninUstundeKazancGuleri());
        System.out.println("   ***   ");
    ...
    private static String getOrtalamaninUstundeKazancGuleri() {//5.adım
        String ortUstGun = "";
        for (int i = 0; i < gunlukKazanclar.size(); i++) {
            if (gunlukKazanclar.get(i) > getOrtalamaKazanc()) {
